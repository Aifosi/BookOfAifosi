...
import bot.chaster.{ChasterClient, ConfigUpdate, DiceConfig, LinkConfig}
...
)(using DiscordLogger) extends ModifierTextWheelCommand[DiceConfig](client, registeredUserRepository):
